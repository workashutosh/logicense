  ...
  return (
    <div className="min-h-screen font-sans bg-cover bg-center" style={{ backgroundImage: 'url("https://keynote.tailwindui.com/_next/static/media/background.6c3571e0.jpg")' }}>    
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 bg-white/5 backdrop-blur-md">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-600 text-center mb-10 sm:mb-12">Why Choose Logisence?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-white/10 rounded-lg hover:bg-white/20 transition-all shadow-xl shadow-blue-400 duration-300">
            <h3 className="text-lg sm:text-xl font-semibold text-blue-600">Custom Solutions</h3>
            <p className="mt-2 text-blue-800 text-sm sm:text-base">Tailored websites and apps built to match your unique vision.</p>
          </div>
          <div className="p-6 bg-white/10 rounded-lg hover:bg-white/20 transition-all shadow-xl shadow-blue-400 duration-300">
            <h3 className="text-lg sm:text-xl font-semibold text-blue-600">Mumbai Expertise</h3>
            <p className="mt-2 text-blue-800 text-sm sm:text-base">Local know-how delivering solutions that resonate with your audience.</p>
          </div>
          <div className="p-6 bg-white/10 rounded-lg hover:bg-white/20 transition-all shadow-xl shadow-blue-400 duration-300">
            <h3 className="text-lg sm:text-xl font-semibold text-blue-600">Affordable Excellence</h3>
            <p className="mt-2 text-blue-800 text-sm sm:text-base">Premium quality starting at just ₹5,000 for landing pages!</p>
          </div>
        </div>
      </section>
    </div>
